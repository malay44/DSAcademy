    ...
    <>
      <label className='themeSwitcherThree relative inline-flex cursor-pointer select-none items-center'>
        <input
          ...
          className='sr-only'
        />
        <div className='shadow-card flex h-[36px] w-[64px] items-center justify-center rounded-md bg-dark-gray-9 dark:bg-white '>
          <span
            className={`flex h-7 w-7 items-center justify-center rounded ${
              !isChecked ? 'bg-primary-blue text-white' : 'text-body-color'
            }`}
          >
            <svg
              width='16'
