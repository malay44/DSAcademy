			...
			<div className="flex flex-col items-center mt-[10vh]">
				...
				<form onSubmit={handleLogin}>
					...
					<input 
						...
						className="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium " 
					/>
					<button type="submit" className="bg-slate-500 hover:bg-slate-700 text-white text-base rounded-lg py-2.5 px-5 transition-colors w-full text-[19px]">{loading ? "Loading..." : "Log In"}</button>
				</form>
				<p className="text-center mt-3 text-[14px]">Don&#x27;t have an account?
					<a href='#'onClick={() => handleClick("register")} className="text-gray-600">Create one</a>
				</p>
