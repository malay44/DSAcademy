    ...
    <div className={`flex flex-col gap-4 ${variant === 'secondary' ? 'mb-4' : 'mb-4'}`}>
      <WrapperComponent className={`flex items-start justify-center ${variant === 'secondary' ? 'mb-2' : ''}`}>
        ...
        <textarea
          ...
          className={`bg-dark-gray-9 border-2 text-dark-gray-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 `}
        />
      </WrapperComponent>
    </div>
  );
